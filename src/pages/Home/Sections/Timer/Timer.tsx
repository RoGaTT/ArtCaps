...
import TimerDaysTextImg from '@/assets/img/timer/days_text.svg';
import TimerHoursTextImg from '@/assets/img/timer/hours_text.svg';
import TimerMinTextImg from '@/assets/img/timer/min_text.svg';
import TimerSecTextImg from '@/assets/img/timer/sec_text.svg';
import TimerMsecTextImg from '@/assets/img/timer/msec_text.svg';
import TimerChipIcon from '@/assets/img/chips/timer.svg';

import FollowUsTextIcon from '@/assets/img/timer/follow_us_text.svg';
