  ...
  return (
    ...
    >
      <div className={classes.title}>
        ...
        <p>
          ArtCaps offers 3 different token collections from three original artists. Each collection consists of 10,000 AI-generated collectibles minted on the Ethereum Blockchain.
        </p>
      </div>
      {
        size.width > 450 && (
